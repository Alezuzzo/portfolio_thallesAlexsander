...
export const workExperiences: Experience[] = [
  {
    ...
    description: [
      "Atuei no desenvolvimento de websites e landing pages para diversos clientes, utilizando tecnologias como React, Next.js, HTML, CSS e JavaScript.",
      "Idealizei, projetei e desenvolvi uma aplicação completa para gerenciamento de orçamentos, contratos e dashboard financeiro, utilizando React, TypeScript, Express e PostgreSQL."
    ],
  },
  {
    id: 2,
